...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery-1.8.3.js"></script><link rel="stylesheet" href="<%= request.getContextPath()%>/resources/css/style.css" type="text/css">
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jpager/js/jPages.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/sql.js"></script>
...
<body>
    ...
    <div id="sqlInputDiv">
        ...
        <form action="sql/sqlsearch" method="post">
            <textarea id="sql" name="sql" value="select ra,dec from admin_csv">select ra,dec from admin_demo</textarea><br/>
    ...
    <div id="SqlDataDiv" style="width: 1024px; height: 700px; margin-top: 10px;">
        ...
        <table class="table table-hover table-bordered">
            ...
            <c:forEach items="${lmps}" var="map">
                ...
                <td><input type="checkbox" name="pathMark" id="pathMark" /></td>
                    ...
                    <c:if test="${havePATH}">
                     <td><a href="${map.PATH}">DOWNLOAD</a></td>
                      <td><a href="./appletindex.jsp?Name=${map.PATH}" target="_blank">SPECVIEW</a></td>
                      </c:if>
                      <c:if test="${haveRaAndDec}">
